...
public class ViewMyItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(ViewMyItemActivity.this);
        context = ViewMyItemActivity.this;
        ...
        if (getIntent().getExtras() != null) {
            ...
            if (item.getLatitude().contentEquals("") || item.getLongitude().contentEquals("")) {
                ...
                String dis= String.valueOf(item.getDistance(ViewMyItemActivity.this))+" km";
                if (item.getDistance(ViewMyItemActivity.this) < 1 && item.getDistance(ViewMyItemActivity.this) < -1) {
                    itemDistance.setText(dis);
                }else {
                    itemDistance.setText(dis);
                }
            }
            Glide.with(ViewMyItemActivity.this)
    ...
    public void sendMessage(View view) {
        ...
        Intent intent = new Intent(ViewMyItemActivity.this, ChatActivity.class);
...
//            mapMark.put(id, null);
    ...
    private void checkBeforAddFriend(final String idFriend) {
        ...
        LovelyProgressDialog dialogWait = new LovelyProgressDialog(ViewMyItemActivity.this);
        ...
        FriendDB.getInstance(ViewMyItemActivity.this).addFriend(user);
