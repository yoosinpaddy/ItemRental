...
public class LoginActivity extends AppCompatActivity {
    ...
    class AuthUtils {
         ...
         */
        void saveUserInfo() {
            FirebaseDatabase.getInstance().getReference().child("profiles/" + StaticConfig.UID).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
        ...
        void initNewUserInfo() {
            ...
            FirebaseDatabase.getInstance().getReference().child("profiles/" + user.getUid()).setValue(newUser);
        }
    }
}
