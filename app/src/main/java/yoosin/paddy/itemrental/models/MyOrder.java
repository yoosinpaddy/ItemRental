...
public class MyOrder implements Serializable {
    ...
    public MyOrder(String id, String longitude, String latitude, String ownerId, String name, String description, String photoUrl, String price, String status, int vote) {
        this.id = id;
    ...
    public MyOrder(MyItem item) {
        ...
        this.secondPartyId = item.secondPartyId;
    }
    public MyOrder(Item item) {
        this.id = item.id;
        this.longitude = item.longitude;
        this.latitude = item.latitude;
        this.ownerId = item.ownerId;
